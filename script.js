...
document.getElementById('input').addEventListener('click', event => {
    ...
    let name = document.getElementById("store").value
    let height = document.getElementById("product").value
    let weight = document.getElementById("quantity").value
    //img = official-artwork
    
    document.getElementById('name').innerHTML = 'name';
    document.getElementById('height').innerHTML = 'name';
